...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::workspace_definition::query_language_completion,
            commands::workspace_definition::query_language_definition,
            ...
            commands::language::prepare_language_document,
            ...
            commands::language::resolve_completion,
            ...
            commands::git_repository::get_git_roots,
            ...
            commands::git_repository::get_git_push_preview,
