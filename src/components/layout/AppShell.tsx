...
export function AppShell({ workspaceApi = defaultWorkspaceApi }: AppShellProps) {
  ...
  function closeEditorCompletion() { requestEditorCompletion("close"); }
  ...
  const gitChangeBaseline = useGitEditorChangeBaseline({ rootPath: gitRoots.selectedRoot, activePath, repositoryGeneration: sourceControl.snapshot?.generation, workspaceApi });
