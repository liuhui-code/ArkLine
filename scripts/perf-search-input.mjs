...
const result = spawnSync(
  ...
  [
    ...
    "--reporter=verbose",
    "-t",
    "keeps search type delete close soak bounded",
  ],
  {
    cwd: process.cwd(),
    stdio: "inherit",
    env: {
      ...
      ARKLINE_SOAK_SEARCH_OPERATIONS: stringArg(args.operations, "100"),
      ARKLINE_SOAK_SEARCH_TARGET_MS: stringArg(args.target, "50"),
